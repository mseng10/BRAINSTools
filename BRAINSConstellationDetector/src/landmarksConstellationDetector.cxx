...
landmarksConstellationDetector::GetLandmarkTransformFromImageTransform( VersorTransformType::ConstPointer orig2msp_img_tfm )
{
...
const LandmarksMapType & updated_orig_lmks)
{
  ...
  if( this->m_orig2msp_img_tfm.IsNull() )
    ...
    const VersorRigid3DTransformType::OutputPointType acPointInACPCSpace = LandmarkOrigToACPCTransform->TransformPoint(GetNamedPointFromLandmarkList(updated_orig_lmks,"AC"));
    ...
    //VersorRigid3DTransformType::OutputPointType newacPointInACPCSpace = LandmarkOrigToACPCTransform->TransformPoint(GetNamedPointFromLandmarkList(updated_orig_lmks,"AC"));
