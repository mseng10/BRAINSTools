...
typename TOutputImage::Pointer RigidResampleInPlayByVersor3D( const typename TInputImage::ConstPointer& image,
...
template <typename TInputImage, typename TOutputImage>
VersorRigid3DTransform<double>::Pointer ResampleFromEyePoints(
  const typename TInputImage::PointType & LE_Point,
